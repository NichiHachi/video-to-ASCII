...
const std::string file_storage_ascii_color_1_path = "frame_ascii_color_1/";
const std::string file_storage_ascii_color_2_path = "frame_ascii_color_2/";
const std::string file_depot_path = "frame_final_product/";
...
int ascii_to_frame_bicolor(int color_selection){
    ...
    int image_x;
    int image_y=0;
    std::fstream input("frame_ascii/0.txt");
    ...
    for(const auto & entry : fs::directory_iterator(file_storage_ascii_path)){
        ...
        std::fstream image(file_storage_ascii_path+std::to_string(frame_number)+".txt");
...
int ascii_to_frame_tricolor(int color_selection){
    ...
    for(int frame_number = 0; frame_number < total_frame; frame_number++){
        ...
        rect.y = 0; 
        rect.h = 40;
        std::fstream image_1(file_storage_ascii_color_1_path+std::to_string(frame_number)+".txt");
        ...
        rect.y = 0; 
        rect.h = 40;
        std::fstream image_2(file_storage_ascii_color_2_path+std::to_string(frame_number)+".txt");
